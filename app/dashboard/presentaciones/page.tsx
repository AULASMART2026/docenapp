...
export default function Presentaciones() {
  ...
  async function descargarPPT() {
    ...
    contenidoSlides.forEach((slide: any, i: number) => {
      ...
      s.background = { color: i === 0 ? "4338CA" : "FFFFFF" };
...
export default function Presentaciones() {
    ...
    contenidoSlides.forEach((slide: any, i: number) => {
      ...
      if (i === 0) {
        ...
        s.addText("DocenApp", {
          ...
          fontSize: 12, color: "A5B4FC", align: "center"
        });
      } else {
        ...
        s.addText(slide.contenido || "", {
          x: 0.5, y: 1.3, w: 9, h: 3.2,
          fontSize: 14, color: "374151",
          bullet: slide.esBullet ? { type: "bullet" } : false,
          valign: "top", wrap: true
        });
        s.addText(i + "/" + (contenidoSlides.length - 1), {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <p className="text-gray-500 text-sm mb-6">Crea presentaciones de clases listas para usar en PowerPoint</p>
      ...
      <div className="bg-white rounded-xl shadow-sm p-6 mb-6 space-y-4">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Tema de la presentacion</label>
        ...
        <button onClick={generar} disabled={loading || tema.length < 3}
          ...
          {loading ? "Generando presentacion..." : "✨ Generar Presentacion con IA"}
        </button>
      </div>
        ...
        <div className="space-y-4">
          <div className="flex gap-3 flex-wrap">
            ...
            {contenidoSlides.length > 0 && (
              <button onClick={descargarPPT} disabled={generandoPPT}
          ...
          {contenidoSlides.length > 0 ? (
            <div className="space-y-3">
              <h2 className="font-semibold text-gray-700">Vista previa de diapositivas</h2>
              {contenidoSlides.map((slide: any, i: number) => (
                <div key={i} className={"rounded-xl p-5 " + (i === 0 ? "bg-indigo-700 text-white" : "bg-white shadow-sm border border-gray-100")}>
                  <div className={"text-xs mb-2 " + (i === 0 ? "text-indigo-200" : "text-gray-400")}>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              <h2 className="font-semibold text-gray-700 mb-4">Contenido generado</h2>

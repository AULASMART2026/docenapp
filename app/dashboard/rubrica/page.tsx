...
const TEMAS: Record<string, string[]> = {
  "Lenguaje y Comunicacion": ["Comprension lectora", "Produccion escrita", "Exposicion oral", "Analisis literario", "Ortografia y redaccion"],
  "Matematica": ["Fracciones", "Geometria", "Algebra", "Estadistica", "Numeros enteros", "Ecuaciones"],
  ...
  "Ingles": ["Present tense", "Past tense", "Vocabulary", "Reading comprehension", "Writing skills"],
  "Educacion Fisica y Salud": ["Vida saludable", "Deportes colectivos", "Atletismo", "Gimnasia", "Alimentacion sana"],
  "Artes Visuales": ["Tecnicas de dibujo", "Pintura", "Historia del arte", "Escultura", "Arte chileno"],
  "Musica": ["Ritmo y melodia", "Instrumentos musicales", "Generos musicales", "Musica chilena", "Lectura musical"],
  "Tecnologia": ["Programacion basica", "Seguridad digital", "Herramientas digitales", "Robotica", "Diseno"],
  "Religion": ["Valores", "Biblica", "Etica", "Espiritualidad", "Convivencia"],
  "Orientacion": ["Autoconocimiento", "Proyecto de vida", "Habilidades sociales", "Prevencion de riesgos"],
  "Filosofia": ["Logica", "Etica", "Teoria del conocimiento", "Filosofia griega"],
  "Quimica": ["Tabla periodica", "Reacciones quimicas", "Acidos y bases", "Organica"],
  "Fisica": ["Cinematica", "Dinamica", "Electricidad", "Ondas", "Termodinamica"],
  "Biologia": ["Genetica", "Evolucion", "Ecologia", "Microbiologia", "Botanica"],
};
